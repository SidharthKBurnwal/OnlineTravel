	            ...
	            <div class="navbar-header">
	                ...
	                <div id="navbar" class="navbar-collapse collapse">
		                <ul class="nav navbar-nav">
		                    <li class="active">
		                        <a href="WelcomeUser.jsp"><span class="glyphicon glyphicon-home" aria-hidden="true"></span> Home</a>
		                    </li>
		                    <li>
		                    ...
		                    <li class="dropdown">
		                        ...
		                        <ul class="dropdown-menu">
		                            <li><a href="SelectTourByPlace.jsp">Select Tour By Place</a></li>
		                            <li><a href="SelectTourByType.jsp">Select Tour By Type</a></li>
		                            <li role="separator" class="divider"></li>
		                            <li>
			                            <form action="DisplayAllTourUserServlet">
		                ...
		                <ul class="nav navbar-nav navbar-right">
		                        ...
		                        <ul class="dropdown-menu">
		                        	<li><a href="FetchCustomerProfileServlet?email=<%=email%>">Edit profile</a></li>
		                        	<li><a href="ViewYourBookingsServlet?email=<%=email%>">View Your Bookings</a></li>
		                            <li><a href="DeleteUserTour.jsp">Cancel Booking</a></li>
